  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        question: 'Sua empresa já discutiu como seria estruturada uma "linha de montagem digital", com processos de negócio rodando de ponta a ponta com agentes de IA orquestrados?',
        options: [
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { letter: 'A', text: 'O agente preenche tudo manualmente no sistema, levando de 2 a 5 minutos por atendimento', points: 1 },
    ...
    questions: [
      {
        ...
        question: 'Sua empresa tem um responsável formal pelos dados que alimentam cada modelo de IA em produção, o "Data Owner"?',
        options: [
